...
export const RESET_PASSWORD_REQUEST =
  '@nextjs-example/AUTH/RESET_PASSWORD_REQUEST';
export const RESET_PASSWORD_SUCCESS =
  '@nextjs-example/AUTH/RESET_PASSWORD_SUCCESS';
export const RESET_PASSWORD_ERROR = '@nextjs-example/AUTH/RESET_PASSWORD_ERROR';
export const CLEAR_RESET_PASSWORD = '@nextjs-example/AUTH/CLEAR_RESET_PASSWORD';

export const CHANGE_PASSWORD_REQUEST =
  '@nextjs-example/AUTH/CHANGE_PASSWORD_REQUEST';
export const CHANGE_PASSWORD_SUCCESS =
  '@nextjs-example/AUTH/CHANGE_PASSWORD_SUCCESS';
export const CHANGE_PASSWORD_ERROR =
  '@nextjs-example/AUTH/CHANGE_PASSWORD_ERROR';
