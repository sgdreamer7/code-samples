class ServicesNamingAdmin(admin.ModelAdmin):
    """
    Customize admin data for model ServiceNaming in admin panel. 
    Filter companies by companies admins.
    """
...
class ServicesAdmin(admin.ModelAdmin):
    """
    Customize admin data for model Services in admin panel. 
    Filter service's companies by companies admins and change admin form querysets.
    """
